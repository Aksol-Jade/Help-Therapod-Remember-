...
# Try Press Start 2P, else fallback to Courier
try:
    retro_font = ("Press Start 2P", 9)
    retro_font_large = ("Press Start 2P", 14)
    retro_font_header = ("Press Start 2P", 22)
except:
    retro_font = ("Courier New", 9)
    retro_font_large = ("Courier New", 14, "bold")
    retro_font_header = ("Courier New", 22, "bold")

# Colors
GRADIENT_TOP = "#ffecd2"
GRADIENT_BOTTOM = "#fcb69f"
BG_COLOR = "#ffffff"      # Main window background (gradient on top)
HEADER_BG = "#f7f7f7"
HEADER_FG = "#ff6f61"
TEXT_FG = "#333333"
BUTTON_BG = "#ff6f61"
...
# The interior "Pokémon style" color:
POKEMON_BOX_BG = "#F8E8C0"  # Beige-like color
POKEMON_BORDER_COLOR = "#000000"  # Black border for strong contrast

CAT_BG = "yellow"  # Make the cat box also beige inside
...
class ReverseAkinatorGUI(tk.Tk):
    def __init__(self):
        super().__init__()
        # Start in maximized (zoomed) state
        self.state("zoomed")
    ...
    def create_widgets(self):
        ...
        # Header
        self.header_frame = tk.Frame(self, bg=HEADER_BG, bd=0, highlightthickness=4,
                                     highlightbackground=POKEMON_BORDER_COLOR)
        ...
        # Left Panel
        # We'll enclose everything in a single "box" with a black border and a beige interior
        ...
        self.left_frame.grid_rowconfigure(2, weight=4)  # Taller status area
        self.left_frame.grid_rowconfigure(3, weight=1)  # Guess area
        ...
        self.name_entry = tk.Entry(self.name_frame, font=retro_font,
                                   ...
                                   highlightcolor=POKEMON_BORDER_COLOR, bg="#FFFFFF")
        self.name_entry.grid(row=0, column=1, sticky="ew", padx=5)
        

        # Top Controls: Group 1 (Theme selection + Start Game) and Group 2 (Volume controls)
        ...
        # Group 1: Theme selection and Start Game button.
        ...
        self.theme_menu.grid(row=0, column=1, sticky="ew", padx=(0,5))
        ...
        self.volume_slider = tk.Scale(self.top_controls, from_=0, to=100, orient="horizontal",
        ...
        self.status_text = tk.Text(self.left_frame, fg=TEXT_FG, font=retro_font,
                                   ...
                                   highlightthickness=4, highlightbackground=POKEMON_BORDER_COLOR,
                                   highlightcolor=POKEMON_BORDER_COLOR, bg="#FDF5E6")
        ...
        self.stopwatch_label = tk.Label(self.stopwatch_frame, text="00:00:00",
        ...
        self.leaderboard_title = tk.Label(self.leaderboard_frame, text="Leaderboard",
                                          font=retro_font_large, bg=POKEMON_BOX_BG, fg=HEADER_FG)
